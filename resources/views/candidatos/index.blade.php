                               ...
                               <li class="p-3 flex items-center">
                                 ...
                                 <div>
                                  <a 
                                    ...
                                    target="_blank"
                                    class=" inline-flex items-center shadow-sm px-2.5 py-0.5 border-gray-300 text-sm leading-5 font-medium rounded-full text-gray-700 bg-white hover:bg-gray-50"
